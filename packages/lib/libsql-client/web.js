...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/promise-limit@2.7.0/node_modules/promise-limit/index.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/core@0.17.4/node_modules/@libsql/core/lib-esm/api.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/core@0.17.4/node_modules/@libsql/core/lib-esm/uri.js
...
function encodeUserinfo(userinfo) {
  ...
  const passwordText = userinfo.password !== void 0
    ? `:${encodeURIComponent(userinfo.password)}`
    : "";
  return `${usernameText}${passwordText}@`;
}

// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/js-base64@3.9.2/node_modules/js-base64/base64.mjs
var version = "3.9.2";
var VERSION = version;
var _TD = typeof TextDecoder === "function"
...
var btoaPolyfill = (bin) => {
  ...
  for (let i = 0; i < bin.length;) {
    if (
      (c0 = bin.charCodeAt(i++)) > 255 || (c1 = bin.charCodeAt(i++)) > 255 ||
      (c2 = bin.charCodeAt(i++)) > 255
    ) {
      throw new TypeError("invalid character found");
    }
    u32 = c0 << 16 | c1 << 8 | c2;
    asc += b64chs[u32 >> 18 & 63] + b64chs[u32 >> 12 & 63] + b64chs[u32 >> 6 & 63] +
      b64chs[u32 & 63];
  }
  return pad ? asc.slice(0, pad - 3) + "===".substring(pad) : asc;
};
var _btoa = typeof btoa === "function" ? (bin) => btoa(bin) : btoaPolyfill;
var _fromUint8Array = typeof Uint8Array.prototype.toBase64 === "function"
  ? (u8a) => u8a.toBase64()
  : (u8a) => {
    const maxargs = 4096;
    let strs = [];
...
var cb_utob = (c) => {
  if (c.length < 2) {
    ...
    return cc < 128
      ...
      : _fromCC(224 | cc >>> 12 & 15) + _fromCC(128 | cc >>> 6 & 63) + _fromCC(128 | cc & 63);
  } else {
    var cc = 65536 + (c.charCodeAt(0) - 55296) * 1024 + (c.charCodeAt(1) - 56320);
    return _fromCC(240 | cc >>> 18 & 7) + _fromCC(128 | cc >>> 12 & 63) +
      _fromCC(128 | cc >>> 6 & 63) + _fromCC(128 | cc & 63);
  }
};
  ...
  switch (cccc.length) {
    case 4:
      var cp = (7 & cccc.charCodeAt(0)) << 18 | (63 & cccc.charCodeAt(1)) << 12 |
          (63 & cccc.charCodeAt(2)) << 6 | 63 & cccc.charCodeAt(3),
        offset = cp - 65536;
...
var atobPolyfill = (asc) => {
  ...
  for (let i = 0; i < asc.length;) {
    u24 = b64tab[asc.charAt(i++)] << 18 | b64tab[asc.charAt(i++)] << 12 |
      (r1 = b64tab[asc.charAt(i++)]) << 6 | (r2 = b64tab[asc.charAt(i++)]);
    if (r1 === 64) {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/core@0.17.4/node_modules/@libsql/core/lib-esm/util.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/core@0.17.4/node_modules/@libsql/core/lib-esm/config.js
...
function expandConfig(config, preferHttp) {
  ...
  const isInMemoryMode = originalUriScheme === "file" && uri.path === inMemoryMode &&
  ...
  for (const { key, value } of uri.query?.pairs ?? []) {
    ...
    if (queryParamDef.values !== void 0 && !queryParamDef.values.includes(value)) {
      throw new LibsqlError(
        `Unknown value for the "${key}" query argument: ${
          JSON.stringify(value)
        }. Supported values are: [${queryParamDef.values.map((x) => '"' + x + '"').join(", ")}]`,
        "URL_INVALID",
      );
    }
  ...
  if (
    scheme !== "http" && scheme !== "ws" && scheme !== "https" && scheme !== "wss" &&
    scheme !== "file"
  ) {
    throw new LibsqlError(
      `The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${
        JSON.stringify(uri.scheme + ":")
  ...
  if (intMode !== "number" && intMode !== "bigint" && intMode !== "string") {
    throw new TypeError(
      `Invalid value for intMode, expected "number", "bigint" or "string", got ${
        JSON.stringify(intMode)
      }`,
    );
  }
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/isomorphic-ws@0.1.5/node_modules/@libsql/isomorphic-ws/web.mjs
var _WebSocket;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/client.js
var Client = class {
  /** @private */
  constructor() {
    this.intMode = "number";
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/errors.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/encoding/json/decode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/encoding/json/encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/encoding/protobuf/util.js
var VARINT = 0;
var FIXED_64 = 1;
var LENGTH_DELIMITED = 2;
var FIXED_32 = 5;

// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/encoding/protobuf/decode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/encoding/protobuf/encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/id_alloc.js
var IdAlloc = class {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/util.js
function impossible(value, message) {
  throw new InternalError(message);
}

// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/value.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/result.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/sql.js
var Sql = class {
  #owner;
  #sqlId;
  #closed;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/queue.js
var Queue = class {
  #pushStack;
  #shiftStack;
  constructor() {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/stmt.js
var Stmt = class {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/batch.js
var Batch = class {
  /** @private */
  _stream;
  #useCursor;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/describe.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/stream.js
var Stream = class {
  /** @private */
  constructor(intMode) {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/cursor.js
var Cursor = class {
};

// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/cursor.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/stream.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/shared/json_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/json_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/shared/protobuf_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/protobuf_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/shared/json_decode.js
function Error2(obj) {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/json_decode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/shared/protobuf_decode.js
var Error3 = {
  default() {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/protobuf_decode.js
var ServerMsg2 = {
  default() {
    return { type: "none" };
  },
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/ws/client.js
  ...
  #onSocketOpen() {
    ...
    if (protocol === void 0) {
      ...
      if (this.#subprotocol === void 0) {
        this.#setClosed(
          new ProtoError(`Unrecognized WebSocket subprotocol: ${JSON.stringify(protocol)}`),
        );
        return;
      }
    }
    ...
    try {
      ...
      if (encoding === "json") {
        if (typeof event.data !== "string") {
          ...
          this.#setClosed(
            new ProtoError("Received non-text message from server with JSON encoding"),
          );
          return;
        }
        ...
        if (!(event.data instanceof ArrayBuffer)) {
          ...
          this.#setClosed(
            new ProtoError("Received non-binary message from server with Protobuf encoding"),
          );
          return;
        }
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/queue_microtask.js
var _queueMicrotask;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/byte_queue.js
var ByteQueue = class {
  #array;
  #shiftPos;
  #pushPos;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/json_decode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/protobuf_decode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/cursor.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/json_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/protobuf_encode.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/stream.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/http/client.js
var checkEndpoints = [
  {
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/hrana-client@0.10.0/node_modules/@libsql/hrana-client/lib-esm/index.js
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/client@0.17.4/node_modules/@libsql/client/lib-esm/hrana.js
        ...
        try {
          ...
          if (mappedError instanceof LibsqlError) {
            throw new LibsqlBatchError(
              ...
              mappedError.rawCode,
              mappedError.cause instanceof Error ? mappedError.cause : void 0,
            );
          }
          throw mappedError;
        }
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/client@0.17.4/node_modules/@libsql/client/lib-esm/sql_cache.js
var SqlCache = class {
  #owner;
  #sqls;
  capacity;
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/client@0.17.4/node_modules/@libsql/client/lib-esm/ws.js
var import_promise_limit = __toESM(require_promise_limit(), 1);
function _createClient(config) {
  if (config.scheme !== "wss" && config.scheme !== "ws") {
    throw new LibsqlError(
      `The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${
  ...
  try {
    ...
    if (e instanceof WebSocketUnsupportedError) {
      ...
      throw new LibsqlError(
        `This environment does not support WebSockets, please switch to the HTTP client by using a "${suggestedScheme}:" URL (${
          JSON.stringify(suggestedUrl)
        }). For more information, please read ${supportedUrlLink}`,
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/client@0.17.4/node_modules/@libsql/client/lib-esm/http.js
var import_promise_limit2 = __toESM(require_promise_limit(), 1);
function _createClient2(config) {
  if (config.scheme !== "https" && config.scheme !== "http") {
    throw new LibsqlError(
      `The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${
        JSON.stringify(config.scheme + ":")
      }. For more information, please read ${supportedUrlLink}`,
      "URL_SCHEME_NOT_SUPPORTED",
    );
...
// ../home/kubuntu/.cache/deno/deno_esbuild/registry.npmjs.org/@libsql/client@0.17.4/node_modules/@libsql/client/lib-esm/web.js
...
function _createClient3(config) {
  if (config.scheme === "ws" || config.scheme === "wss") {
    ...
    throw new LibsqlError(
      `The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${
        JSON.stringify(config.scheme + ":")
      }. For more information, please read ${supportedUrlLink}`,
      "URL_SCHEME_NOT_SUPPORTED",
    );
...
export { _createClient3 as _createClient, createClient, LibsqlBatchError, LibsqlError };
