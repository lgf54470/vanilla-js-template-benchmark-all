...
import { registerTranslations } from "../../shared/lib/i18n.js";
...
registerTranslations("en", "components", en);

let unbindHashListener = null;
...
export default {
  mount(container) {
    ...
    unbindHashListener = () => globalThis.removeEventListener("hashchange", onHashChange);
  },

  unmount() {
    if (unbindHashListener) {
      unbindHashListener();
      unbindHashListener = null;
    }
  },
};
